  ...
  return (
    <div className="container my-5">
      ...
      <form className="card p-4 shadow" onSubmit={handleSubmit}>
        ...
        <h6 className="text-center text-muted mb-4">Step {step} of {isGoogleUser ? 2 : 3}</h6>
          ...
          <>
            ...
            {step === 2 && (
              <>
                ...
                <div className="mb-3">
                  <label>Charge</label>
                  <input name="Charge_Per_Hour_or_Day" className="form-control" value={formData.Charge_Per_Hour_or_Day} onChange={handleChange} required />
                </div>
